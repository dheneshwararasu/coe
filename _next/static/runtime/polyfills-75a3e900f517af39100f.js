                ...
                ! function() {
                    ...
                    var Vr = "\t\n\v\f\r \xa0\u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029\ufeff",
                        ...
                        Yr = function(t) {
                            return function(e) {
                                var r = String(v(e));
                                return 1 & t && (r = r.replace(Xr, "")), 2 & t && (r = r.replace(Hr, "")), r
                            }
                        },
                        Jr = {
                            start: Yr(1),
                    ...
                    (Vo || Xo || qo) && ($o = function(t) {
                        var e, r, n, o, i = this,
                            ...
                            s = 0,
                            f = t;
                        return a && (-1 === (u = u.replace("y", "")).indexOf("g") && (u += "g"), f = String(t).slice(i.lastIndex), i.lastIndex > 0 && (!i.multiline || i.multiline && "\n" !== t[i.lastIndex - 1]) && (c = "(?: " + c + ")", f = " " + f, s++), r = new RegExp("^(?:" + c + ")", u)), Xo && (r = new RegExp("^" + c + "$(?!\\s)", u)), Vo && (e = i.lastIndex), n = Ko.call(a ? r : i, f), a ? n ? (n.input = n.input.slice(s), n[0] = n[0].slice(s), n.index = i.lastIndex, i.lastIndex += n[0].length) : i.lastIndex = 0 : Vo && n && (i.lastIndex = i.global ? n.index + n[0].length : e), Xo && n && n.length > 1 && Go.call(n[0], r, (function() {
                            var t = arguments;
                    ...
                    ci("split", 2, (function(t, e, r) {
                        ...
                        return n = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(t, r) {
                            ...
                            for (var i, a, u, c = [], s = 0, f = new RegExp(t.source, (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : "") + "g");
                                (i = Ho.call(f, n)) && !((a = f.lastIndex) > s && (c.push(n.slice(s, i.index)), i.length > 1 && i.index < n.length && yi.apply(c, i.slice(1)), u = i[0].length, s = a, c.length >= o));) f.lastIndex === i.index && f.lastIndex++;
                    ...
                    uu && cu || (uu = function(t) {
                        ...
                        lu.now(vu(t))
                    } : fu && !iu ? (nu = (ru = new fu).port2, ru.port1.onmessage = gu, eu = Qt(nu.postMessage, nu, 1)) : !o.addEventListener || "function" != typeof postMessage || o.importScripts || i(yu) || "file:" === au.protocol ? eu = "onreadystatechange" in x("script") ? function(t) {
